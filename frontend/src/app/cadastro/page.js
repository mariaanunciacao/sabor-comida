      ...
      <div className="relative z-10 w-full max-w-lg overflow-hidden rounded-[2rem] border border-white/20 bg-white/92 shadow-[0_22px_70px_rgba(0,0,0,0.24)] backdrop-blur-sm">
        ...
        <div className="space-y-6 p-8">
          <div className="space-y-2">
            ...
            <div className="text-sm text-gray-600">Crie sua conta para continuar no Sabor Comida</div>
          </div>
          ...
          <div className="flex items-center justify-between gap-3 text-sm">
            ...
            <Link href="/login" title="Será enviado um e-mail para você" className="font-semibold text-(--color-titulos) hover:opacity-80">
              Faça login
            </Link>
          </div>
        </div>
